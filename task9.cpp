...
const char *start_of_string;    // Адрес начала строки
...
//    std::cout << "start" << thr_number << "\n";
    char *left_it;  // адес левой границы интервала, с которым будет работать только этот поток
    char *right_it; // адес правой границы интервала, с которым будет работать только поток
    do {
